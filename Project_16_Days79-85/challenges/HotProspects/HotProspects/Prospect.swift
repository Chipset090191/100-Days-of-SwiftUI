...
@MainActor class Prospects: ObservableObject {
    ...
    let saveKey = "SavedData"                                       // you cannot write data form somewhere except our Prospects class!
...
//        }
        ...
        let filename = FileManager.documentsirectory.appendingPathComponent(saveKey)
    ...
    private func save() {                 // we use private because no one else should call save() except of our

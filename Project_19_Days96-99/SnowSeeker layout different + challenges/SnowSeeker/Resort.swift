...
struct Resort: Codable, Identifiable {
    ...
    var facilityTypes: [Facility] {
        facilities.map(Facility.init)  // here by using "map" we initialize our struct Facility for every element of array facilities and then put it and create new array facilityTypes
    }

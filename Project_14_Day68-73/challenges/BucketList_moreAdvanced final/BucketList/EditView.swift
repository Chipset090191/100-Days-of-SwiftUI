...
//                    SaveButton(location: location, onSave: (Location) -> Void, name: $name, description: $description)
                    Button ("Save") {
...
//MARK: here was the func for fethcing data
...
//        EditView(location: Location.example) { _ in }  // - we ignore the value of a closure completion here
//    }
//}
